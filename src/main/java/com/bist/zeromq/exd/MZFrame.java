...
public class MZFrame
{
     ...
     */
    public MZFrame duplicate()
    {
        return new MZFrame(this.data);
    }
     ...
     */
    public boolean hasSameData(MZFrame other)
    {
        if (other == null) {
            return false;
        }
     ...
     *              received frame, else null
     */
    public static MZFrame recvFrame(Socket socket, int flags)
    {
        MZFrame f = new MZFrame();
    ...
    public static MZFrame recvFrame(Socket socket, int flags,MZFrame f)
    {
        byte[] data = f.recv(socket, flags);
        if (data == null) {
            return null;
